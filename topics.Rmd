...
|  | Th 10/24 | Continuous Probability Distributions | Understand Known Continuous Probability Distributions | Assigned: Homework 3 | Sect. 5.4-5.6 [B] |
| **10** | Tu 10/29 | Expectation and Variance of Continuous Random Variables | Compute the Expectation | - | Sect. 6.1-6.2 [B] |
|  | Th 10/31 | Moment Generating Functions | Determine the Moments | - | Sect. 6.3-6.5 [B] |
| **11** | Tu 11/5 | Joint and Marginal Distributions | TBA | - | Sect. 7.1-7.3 [B] |
|  | Th 11/7 | Conditional Distributions | TBA | Assigned: Homework 4 | Sect. 7.4-7.5 [B] |
| **12** | Tu 11/12 | Conditional Expectation and Variance | TBA | - | Sect. 9.1-9.5 [B] |
|  | Th 11/14 | Limit Theorems | TBA | - | Sect. 10.2-10.4 [B] |
| **13** | Tu 11/19 | _Review_ | Exam 2 Examples | - | Exam 2 Topics |
|  | Th 11/21 | **Exam 2** | - | - | - |
| **14** | Tu 11/26 | Markov Property | TBA | - | Sect. 11.1-11.2 [B] |
|  | Th 11/28 | _Thanksgiving Vacation_ | - | - | - |
| **15** | Tu 12/3 | Stationary Distributions of Markov Chains | TBA | - | Sect. 11.3-11.4 [B] |
|  | Th 12/5 | Markov Chain Monte Carlo | TBA | - | Sect. 12.1-12.2 [B] |
